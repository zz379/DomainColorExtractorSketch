...
module.exports = "file://" + String(context.scriptPath).split(".sketchplugin/Contents/Sketch")[0] + ".sketchplugin/Contents/Resources/_webpack_resources/8fba64d12451565163bd66258108a355.html";
...
/*!***************************!*\
  !*** ./src/my-command.js ***!
  \***************************/
/*! exports provided: default, onSetUp, onTearDown */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "default", function() { return onRun; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onSetUp", function() { return onSetUp; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "onTearDown", function() { return onTearDown; });
...
function onRun(context) {
  var browserWindow = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.webView; // 接收 webview 中的消息事件

  browserWindow.webContents.on('extractImageData', function (i) {
    checkSelectedLayers(browserWindow);
  }).on('copyResult', function (result) {
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message(result ? '复制成功' : '复制失败，请手动复制');
  }); // 加载插件页面

  browserWindow.loadURL(__webpack_require__(/*! ../resources/ui.html */ "./resources/ui.html"));
}
function onSetUp(context) {
  // 恢复插件上次移动后的坐标
  var Settings = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.Settings;
  var x = Settings.settingForKey('main_color_extractor_position_x');
  var y = Settings.settingForKey('main_color_extractor_position_y'); // console.log("BrowserWindow X=" + x + " Y=" + y);

  sketch__WEBPACK_IMPORTED_MODULE_0___default.a.webView = new sketch_module_web_view__WEBPACK_IMPORTED_MODULE_1___default.a({
    width: 240,
    height: 251,
    resizable: false,
    movable: false,
  ...
  if (x != undefined && y != undefined) {
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.webView.setPosition(x, y, false);
  }
}
function onTearDown(context) {
  // 保存插件移动后的坐标
  var position = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.webView.getPosition(); // console.log("BrowserWindow X=" + position[0] + " Y=" + position[1]);
  ...
  sketch__WEBPACK_IMPORTED_MODULE_0___default.a.webView.destroy();
}

function checkSelectedLayers(browserWindow) {
  var selectedDocument = sketch__WEBPACK_IMPORTED_MODULE_0___default.a.getSelectedDocument(); // 判断选中的图层的数量

  var selection = selectedDocument.selectedLayers;

  if (selection.isEmpty || selection.length != 1) {
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message('Please select only one layer');
    return;
  } // 判断选中的图层是否是图片图层
  ...
  if (!layer.image) {
    sketch__WEBPACK_IMPORTED_MODULE_0___default.a.UI.message('Please select the image layer');
    return;
  ...
  var imageData = layer.image; // return a native NSImage
  // let nsimage = imageData.nsimage;
  // return a native NSData representation of the image

  var nsdata = imageData.nsdata; // { width: 100, height: 100 }
  ...
  var base64String = nsdata.base64EncodedStringWithOptions(0);
  console.log("图片数据：" + base64String);
  var commandStr = 'extractColorFromImageData("' + base64String + '")';
...
globalThis['onSetUp'] = __skpm_run.bind(this, 'onSetUp');
globalThis['onTearDown'] = __skpm_run.bind(this, 'onTearDown')
